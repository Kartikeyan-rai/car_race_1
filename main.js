...
function up()
{
    if(car_y>=0){car_y=car_y-10 ;uploadbackground(); uploadrover();uploadrover1(); }
}
function down()
{
    if(car_y<=500){car_y=car_y+10 ;uploadbackground(); uploadrover();uploadrover1(); }
}
function left()
{
    if(car_x>=0){car_x=car_x-10 ;uploadbackground(); uploadrover();uploadrover1(); }
}
function right()
{
    if(car_x<=800){car_x=car_x+10 ;uploadbackground(); uploadrover();uploadrover1(); }
}
function up1()
{
    if(car1_y>=0){car1_y=car1_y-10 ;uploadbackground(); uploadrover1();uploadrover(); }
}
function down1()
{
    if(car1_y<=500){car1_y=car1_y+10 ;uploadbackground(); uploadrover1();uploadrover(); }
}
function left1()
{
    if(car1_x>=0){car1_x=car1_x-10 ;uploadbackground(); uploadrover1(); uploadrover();}
}
function right1()
{
    if(car1_x<=800){car1_x=car1_x+10 ;uploadbackground(); uploadrover1(); uploadrover();}
}